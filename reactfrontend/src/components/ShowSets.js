...
class ShowSets extends Component {
  ...
  componentDidMount(){
    ...
    function initialize()
    {
    	...
    	buttons = 	[
				new Button(0.3, 0.2, 0.1, 0.12, "rgb(100,100,100)", "rgb(150,150,150)", "rgb(0,0,0)", 6, "None", "/placeholder"),
				new Button(0.5, 0.2, 0.1, 0.12, "rgb(100,100,100)", "rgb(150,150,150)", "rgb(0,0,0)", 6, "None", "/placeholder"),
				new Button(0.7, 0.2, 0.1, 0.12, "rgb(100,100,100)", "rgb(150,150,150)", "rgb(0,0,0)", 6, "None", "/placeholder"),
				new Button(0.2, 0.45, 0.1, 0.12, "rgb(255,50,50)", "rgb(255,100,100)", "rgb(0,0,0)", 6, "animals.png", "/animals"),
				new Button(0.4, 0.45, 0.1, 0.12, "rgb(0,150,255)", "rgb(50,200,255)", "rgb(0,0,0)", 6, "None", "/household"),
				new Button(0.6, 0.45, 0.1, 0.12, "rgb(150,35,255)", "rgb(200,85,255)", "rgb(0,0,0)", 6, "None", "/family"),
				new Button(0.8, 0.45, 0.1, 0.12, "rgb(255,150,0)", "rgb(255,200,50)", "rgb(0,0,0)", 6, "None", "/school"),
				new Button(0.3, 0.7, 0.1, 0.12, "rgb(0,206,209)", "rgb(50,255,255)", "rgb(0,0,0)", 6, "None", "/placeholder"),
				new Button(0.5, 0.7, 0.1, 0.12, "rgb(255,100,125)", "rgb(255,150,175)", "rgb(0,0,0)", 6, "None", "/placeholder"),
				new Button(0.7, 0.7, 0.1, 0.12, "rgb(255,200,0)", "rgb(255,255,50)", "rgb(0,0,0)", 6, "None", "/placeholder"),
    				];
